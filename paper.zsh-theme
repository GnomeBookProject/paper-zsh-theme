right_triangle() { # Ending arrow.
   echo $'\ue0b0'
}

prompt_indicator() { # Arrow indicator
   echo  $'\ue0b0'
}
...
ok_username() {
   ARROW_FG="016" # uname
   ARROW_BG="027" # 1st arrow color "Blue".
   NEXT_ARROW_BG="084" # 2nd arrow color "Green."
   NEXT_ARROW_FG="027" # 1st arrow color "Blue."
...
directory() {
   ARROW_FG="016"
   ARROW_BG="084" # 2nd arrow color "Green."
   NEXT_ARROW_BG="126" # 3rd arrow color "".
   NEXT_ARROW_FG="084" # 2nd arrow color "Green".
...
git_prompt() {
   ARROW_FG="016"
   ARROW_BG="126" # 3rd arrow color "".
   NEXT_ARROW_BG=""
   NEXT_ARROW_FG="126" # 3rd arrow color "".
